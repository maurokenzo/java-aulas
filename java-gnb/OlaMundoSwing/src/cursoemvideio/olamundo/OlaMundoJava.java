 ...
 */
package cursoemvideio.olamundo;
...
public class OlaMundoJava extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblMensagem.setFont(new java.awt.Font("Lucida Grande", 1, 24)); // NOI18N
        lblMensagem.setForeground(new java.awt.Color(51, 51, 255));
        lblMensagem.setText("Aqui vai aparecer o texto");

        btnClique.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
    ...
    private void btnCliqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCliqueActionPerformed
        ...
        lblMensagem.setText("Olá mundo grande!!!");
